  ...
  return (
    <>
      <Helmet>
        ...
        <title>Barbershop Aachen | Herren Frisör</title>
        <meta
          name="description"
          content="Besuche unseren Premium Barbershop Herren Frisör in Aachen für erstklassige Haarschnitte, Bartpflege und individuelle Styles. Jetzt Termin buchen!"
        />
        <meta
          name="keywords"
        ...
        {/* Open Graph */}
        <meta property="og:title" content="Herren Frisör | Premium Barbershop Aachen" />
        <meta
        ...
        <meta name="twitter:title" content="Herren Frisör | Premium Barbershop Aachen" />
        <meta
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            "address": {
              "@type": "PostalAddress",
              "streetAddress": "Promenadenstraße 43",
